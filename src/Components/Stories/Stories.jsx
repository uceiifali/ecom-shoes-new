          ...
          <Splide options={splideOptions}>
            {news.map((item, i) => (
              <SplideSlide className="mb-0.5 " key={i}>
                <div className="relative gird items-center gap-4 pb-2 rounded-lg shadow shadow-slate-200 ring-1 ring-slate-200  ">
                  ...
                  <div className="grid items-center justify-start px-4 gap-2 ">
