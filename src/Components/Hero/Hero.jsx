      ...
      <div className="relative h-auto w-auto flex flex-col">
        ...
        <div className="relative z-20 opacity-100 grid items-center justify-items-center nike-container">
          <div className="grid items-center justify-items-center mt-28 md:mt-24">
            ...
            <div className="grid items-center gap-5 md:gap-3 absolute top-[33vh] lg:top-[27vh]  left-[11%] xl:left-0 w-auto h-aut">
              {videos?.map((item, i) => (
                <Clips imgsrc={item.imgsrc} clip={item.clip} key={i} />
              ))}
            </div>
            <div className="grid items-center absolute top-[33vh] lg:top-[27vh] right-0 gap-3">
              {sociallinks?.map((item, key) => (
                <SocialLinks key={key} icon={item.icon} />
              ))}
            </div>
          </div>
          <div>
            <img
              src={img}
              alt="hero-img"
              className="w-auto h-[40vh] lg:h-[35vh] md:h-[31vh] sm:h-[21vh] xsm:h-[19vh] transitions-theme -rotate-[25deg] hover:rotate-0 cursor-pointer object-fill mt-2"
            />
          </div>
        </div>
      </div>
